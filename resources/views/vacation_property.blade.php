  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <div class="feat_box"> <img src="{{asset($property->image)}}" class="img-responsive" alt="">
            <div class="frosale"> <a href="#"> For Sale</a></div>
            <div class="price"> <a href="#"> $ {{$property->price}}/M</a></div>
            <div class="feat_text">
              <h6>{{$property->name}}</h6>
              <p>{{$property->address}}</p>
              <a href="{{route('property_detail', $property->id)}}" class="blue_btn pull-right">View Details </a>
              <ul class="list-inline">
                <li>Beds:{{$property->beds}}</li>
                <li>Baths:{{$property->baths}} </li>
                <li>Sq Ft:{{$property->area}}</li>
              </ul>
              <h5>{{$property->type}}</h5>
