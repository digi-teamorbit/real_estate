    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Privacy Policy</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/privacy-policy/create') }}"><i
                                    class="icon-plus"></i> Add Privacy Policy</a>
                            ...
                            @foreach($privacypolicy as $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/admin/privacy-policy/' . $item->id) }}"
                                            ...
                                            <a href="{{ url('/admin/privacy-policy/' . $item->id . '/edit') }}"
                                            ...
                                            {!! Form::open([
                                       'method'=>'DELETE',
                                       'url' => ['/admin/privacy-policy', $item->id],
