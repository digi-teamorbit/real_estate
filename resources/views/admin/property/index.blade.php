    ...
    <div class="container-fluid bg-white mt-5">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card-body">
                    <h3 class="box-title pull-left">Property</h3>
                    
                        <a class="btn btn-success pull-right" href="{{ url('/admin/property/create') }}"><i
                                    class="icon-plus"></i> Add Property</a>
                    ...
                    <div class="table-responsive">
                        <table class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info" id="myTable">
                            ...
                            <tr class="text-center">
                                <th>#</th>
                                <th>Name</th><th>Address</th><th>Image</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($property as $item)
                                <tr class="text-center">
                                    <td>{{ $item->id }}</td>
                                    <td>{{ $item->name }}</td><td>{{ $item->address }}</td><td><img src="{{asset($item->image)}}"></td>
                                    <td>
                                        ...
                                        <a href="{{ url('/admin/property/' . $item->id) }}"
                                            ...
                                            <a href="{{ url('/admin/property/' . $item->id . '/edit') }}"
                                               title="Edit Property">
