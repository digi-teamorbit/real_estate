      ...
      <div class="col-xs-12 col-sm-8 col-md-8 col-md-offset-2 col-sm-offset-2">
        ...
        <div class="link_list text-center ">
           <ul class="list-inline">
             ...
             <li><a href="{{route('tenant_2')}}"  class="active">CONTACT LANDLORD </a></li>
             <li><a href="{{route('tenant_3')}}">MAINTENANCE REQUEST </a></li>
        ...
        <div class="form_main">
          <h4>CONTACT LANDLORD</h4>
           <form>
            ...
            <textarea placeholder="Purpose to Contact"></textarea>
