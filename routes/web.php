...
Route::get('/account-page','HomeController@account')->name('account_page');
Route::get('/avail','HomeController@avail')->name('avail');
Route::get('/contact','HomeController@contact')->name('contact');
Route::get('/privacy','HomeController@privacy')->name('privacy');
Route::get('/property','HomeController@property')->name('property');
Route::get('/vacation-property/{property}','HomeController@propertyDetail')->name('property_detail');
Route::get('/tenant_1','HomeController@tenant_1')->name('tenant_1');
Route::get('/tenant_2','HomeController@tenant_2')->name('tenant_2');
Route::get('/tenant_3','HomeController@tenant_3')->name('tenant_3');
Route::get('/tenant_4','HomeController@tenant_4')->name('tenant_4');
Route::get('/terms','HomeController@terms')->name('terms');
Route::get('/vacation-rental/{location}','HomeController@vacationProperty')->name('vacation_property');
Route::get('/vacation-rental','HomeController@vacationRental')->name('vacation_rental');
...
Route::resource('admin/privacy-policy', 'Admin\\PrivacyPolicyController');
